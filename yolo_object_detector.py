...
yolo_models_path = "models"

class YoloObjectDetector:
    """
    Class implements Yolo5 model to make inferences on a YouTube video using OpenCv2.
    """
    def __init__(self, yolo_model_name, enable_gpu):
        # https://docs.ultralytics.com/tutorials/pytorch-hub/
        # torch.set_num_threads(32)
        model_path = os.path.join(yolo_models_path, yolo_model_name)
    ...
    def print_classes(self):
        """
        Print classes that model can detect and the length of them.
